...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require4 = __webpack_require__(475);

	var Tabs = _require4.Tabs;
	...
	var _leftNavFirst = _require7.leftNavFirst;
	var _leftNavNext = _require7.leftNavNext;
	var _achieveSelfModules = _require7.achieveSelfModules;
	var _achieveCombineModules = _require7.achieveCombineModules;

	var _require8 = __webpack_require__(283);

	var scorewebStore = _require8.scorewebStore;

	var _require9 = __webpack_require__(305);

	var Provider = _require9.Provider;
	var connect = _require9.connect;

	var _require10 = __webpack_require__(284);

	var createStore = _require10.createStore;
	var applyMiddleware = _require10.applyMiddleware;
	...
	var component = function (_React$Component) {
	    ...
	    _createClass(component, [{
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(Breadcrumb, { breadcrumbMsg: '模型管理' })
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'content' },
	                        React.createElement(
	                            ...
	                            React.createElement(Tabs, {
	                                achieveSelfModules: function achieveSelfModules(requestData) {
	                                    return dispatch(_achieveSelfModules(requestData));
	                                },
	                                achieveCombineModules: function achieveCombineModules(requestData) {
	                                    return dispatch(_achieveCombineModules(requestData));
	                                },
	                                dispatch: dispatch,
	        ...
	        value: function componentDidMount() {
	            ...
	            dispatch(_achieveSelfModules({ "page": 1, "count": 10 }));
	        ...
	        value: function setPage(active) {
	            ...
	            var tabsData = _props2.tabsData;

	            var currentTableName = '';
	            for (var i = 0, len = tabsData; i < len; i++) {
	            ...
	            switch (currentTableName) {
	                case 'selfModules':
	                    return dispatch(_achieveSelfModules({ "page": active.active, "count": 10 }));
	                case 'combineModules':
	                    return dispatch(_achieveCombineModules({ "page": active.active, "count": 10 }));
	            }
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./mod-manage.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./mod-manage.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tabsSwitch = _require.tabsSwitch;
	...
	var Tabs = exports.Tabs = function (_React$Component) {
	    ...
	    _createClass(Tabs, [{
	        ...
	        value: function createTabs() {
	            ...
	            var tabsData = this.props.tabsData;
	            ...
	            var _loop = function _loop(i, len) {
	                var _tabsData$i = tabsData[i];
	                var name = _tabsData$i.name;
	                var desc = _tabsData$i.desc;
	                var selected = _tabsData$i.selected;
	                var requestData = _tabsData$i.requestData;

	                var selectedClass = 'icon-weixuanzhong';
	                if (selected) {
	                    selectedClass = 'icon-xuanzhong';
	                }
	                tabsNode.push(React.createElement(
	                    'li',
	                    { className: 'tabs-item', key: i, onClick: function onClick(e) {
	                            return _this2.clickIcon(e, i, name, selected, requestData);
	                        } },
	                    React.createElement('i', { className: 'iconfont ' + selectedClass }),
	                    React.createElement(
	                        'span',
	                        { className: 'tabs-name' },
	                        desc
	        ...
	        key: 'clickIcon',
	        value: function clickIcon(e, i, name, selected, requestData) {
	            var _props = this.props;
	            var dispatch = _props.dispatch;
	            var achieveSelfModules = _props.achieveSelfModules;
	            var achieveCombineModules = _props.achieveCombineModules;
	            var tabsData = _props.tabsData;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./tabs.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./tabs.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-tabs .tabs-item {\n  float: left;\n  cursor: pointer; }\n  .module-tabs .tabs-item .tabs-name {\n    margin: 0 10px;\n    font-size: 12px;\n    color: #333; }\n\n.module-tabs .iconfont {\n  font-size: 12px;\n  font-family: \"iconfont\" !important;\n  font-style: normal;\n  -webkit-font-smoothing: antialiased;\n  -webkit-text-stroke-width: 0.2px;\n  -moz-osx-font-smoothing: grayscale; }\n\n.module-tabs .icon-weixuanzhong:before {\n  content: \"\\E638\";\n  color: #999; }\n\n.module-tabs .icon-xuanzhong:before {\n  color: #2AC5C9;\n  content: \"\\E630\"; }\n", ""]);
