...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require4 = __webpack_require__(266);

	var Breadcrumb = _require4.Breadcrumb;

	var _require5 = __webpack_require__(496);

	var ModifyPassword = _require5.ModifyPassword;
	...
	var _require7 = __webpack_require__(499);

	var userInfoList = _require7.userInfoList;
	var _modifySelfInfo = _require7.modifySelfInfo;
	var _verifyOldPassWord = _require7.verifyOldPassWord;
	var _verifyCode = _require7.verifyCode;
	var _modifyPassWord = _require7.modifyPassWord;
	    ...
	    _createClass(component, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'userDiv container' },
	                    React.createElement(
	                        'div',
	                        { className: 'breadcrumb-container' },
	                        React.createElement(Breadcrumb, { breadcrumbMsg: '我的设置' })
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'content' },
	                        React.createElement(Message, { userMessage: userMessage,
	                            modifySelfInfo: function modifySelfInfo(data) {
	                                return dispatch(_modifySelfInfo(data));
	                            } }),
	                        React.createElement(ModifyPassword, { userMessage: userMessage,
	                            verifyOldPassWord: function verifyOldPassWord(data) {
	                                return dispatch(_verifyOldPassWord(data));
	                            },
	                            verifyCode: function verifyCode(data) {
	                                return dispatch(_verifyCode(data));
	                            },
	                            modifyPassWord: function modifyPassWord(data) {
	                                return dispatch(_modifyPassWord(data));
	                            } })
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./user-info.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./user-info.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-user-info .userDiv {\n  position: absolute;\n  z-index: -1;\n  top: 75px; }\n\n.module-user-info .container .content {\n  box-sizing: border-box; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Message = exports.Message = function (_React$Component) {
	    ...
	    function Message(props) {
	        ...
	        var listMessage = _this.props.userMessage.listMessage;
	    ...
	    _createClass(Message, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                'div',
	                { className: 'module-user-message clearfix' },
	                React.createElement(
	                    'p',
	                    { className: "head" + (show ? '' : ' header'), onClick: function onClick(e) {
	                            return _this2.show();
	                        } },
	                    '基本信息',
	                    React.createElement('span', { className: 'iconfont spanArrows' })
	                ),
	                React.createElement(
	                    'div',
	                    { className: "div clearfix" + (show ? '' : ' after') },
	                    React.createElement(
	                        'ul',
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'label',
	                                { key: 'labelMobile', className: 'label' },
	                                React.createElement(
	                                    'span',
	                            ...
	                            React.createElement('input', { type: 'text', className: "input" + (me.mobile ? ' red-border' : ''), value: list.mobile,
	                                onChange: function onChange(e) {
	                                    return _this2.handleChange(e, "mobile");
	                                }, onBlur: function onBlur(e) {
	                                    return _this2.blur(e, "mobile");
	                                } }),
	                            React.createElement(
	                                'p',
	                                { className: "hint" + (me.mobile ? ' verify' : '') },
	                                me.mobileName
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'label',
	                                { key: 'labelRealName', className: 'label' },
	                                '真实姓名'
	                            ),
	                            React.createElement('input', { type: 'text', className: 'input', value: list.realName,
	                                onChange: function onChange(e) {
	                                    return _this2.handleChange(e, "realName");
	                                } })
	                        ),
	                        React.createElement(
	                            'li',
	                            ...
	                            React.createElement(
	                                'label',
	                                { key: 'labelEmail', className: 'label' },
	                                React.createElement(
	                                    'span',
	                                    { className: 'span after' },
	                                    '*'
	                            ...
	                            React.createElement('input', { type: 'text', className: "input" + (me.email ? ' red-border' : ''), value: list.email,
	                                onChange: function onChange(e) {
	                                    return _this2.handleChange(e, "email");
	                                }, onBlur: function onBlur(e) {
	                                    return _this2.blur(e, "email");
	                                } }),
	                            React.createElement(
	                                'p',
	                                { className: "hint" + (me.email ? ' verify' : '') },
	                                me.emailName
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'label',
	                                { key: 'labelDepartment', className: 'label' },
	                                '所在公司'
	                            ),
	                            React.createElement('input', { type: 'text', className: 'input', value: list.department,
	                                onChange: function onChange(e) {
	                                    return _this2.handleChange(e, "department");
	                                } })
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'a',
	                            { href: 'javascript:;', className: 'a submit', onClick: function onClick(e) {
	        ...
	        key: 'componentWillReceiveProps',
	        value: function componentWillReceiveProps(nextProps) {
	            var list = nextProps.userMessage.listMessage;
	            this.setState({
	                list: list
	            });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./user-message.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./user-message.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-user-message {\n  width: 100%;\n  float: left;\n  min-width: 800px;\n  border: 1px solid #ededed;\n  border-radius: 3px; }\n  .module-user-message input, .module-user-message button, .module-user-message select, .module-user-message textarea {\n    outline: none;\n    border: none; }\n  .module-user-message textarea {\n    resize: none; }\n  .module-user-message .head {\n    cursor: pointer;\n    background-color: #f8f8f8;\n    border-radius: 3px;\n    color: #343434;\n    font-size: 12px;\n    padding-left: 20px;\n    margin: 0;\n    line-height: 20px; }\n  .module-user-message .header {\n    padding: 5px 20px;\n    border-bottom: 1px solid #ededed;\n    border-radius: 3px 3px 0 0; }\n  .module-user-message .div {\n    display: none;\n    width: 50%;\n    padding: 0 25%; }\n  .module-user-message .ul {\n    list-style-type: none;\n    margin: 0;\n    padding: 0;\n    font-size: 14px; }\n  .module-user-message .li {\n    float: left;\n    width: 100%;\n    margin-top: 20px;\n    line-height: 30px; }\n  .module-user-message .label {\n    float: left;\n    text-align: right;\n    width: 80px;\n    margin-right: 5px;\n    color: #333; }\n  .module-user-message .input {\n    width: 250px;\n    height: 30px;\n    float: left;\n    border: 1px solid #b5b5b5;\n    border-radius: 3px;\n    color: #b5b5b5;\n    font-size: 12px;\n    line-height: 30px; }\n  .module-user-message .p {\n    margin: 0;\n    padding: 0; }\n  .module-user-message .a {\n    text-decoration: none;\n    color: #fff;\n    text-align: center;\n    font-size: 14px;\n    width: 100px;\n    height: 30px;\n    border-radius: 3px;\n    float: left;\n    line-height: 30px;\n    margin: 20px 0 20px 85px; }\n  .module-user-message .span {\n    display: none;\n    color: #ff331a; }\n  .module-user-message .after {\n    display: inline-block; }\n  .module-user-message .submit {\n    background-color: #e84c3d; }\n  .module-user-message .return {\n    background-color: #45bed9; }\n  .module-user-message .CodeImg {\n    cursor: pointer; }\n  .module-user-message .hint {\n    padding: 0;\n    float: left;\n    width: 100%;\n    margin: 5px 0 0 85px;\n    color: #e74c3c;\n    font-size: 12px;\n    display: none;\n    line-height: normal; }\n  .module-user-message .red-border {\n    border: 1px solid #e74c3c; }\n  .module-user-message .verify {\n    display: block; }\n  .module-user-message .iconfont {\n    font-family: \"iconfont\" !important;\n    font-size: 13px;\n    font-style: normal;\n    -webkit-font-smoothing: antialiased;\n    -webkit-text-stroke-width: 0.2px;\n    -moz-osx-font-smoothing: grayscale; }\n  .module-user-message .spanArrows:before {\n    color: #ededed;\n    content: \"\\E627\";\n    float: right;\n    margin-right: 20px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModifyPassword = exports.ModifyPassword = function (_React$Component) {
	    ...
	    function ModifyPassword(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ModifyPassword).call(this, props));
	    ...
	    _createClass(ModifyPassword, [{
	        ...
	        value: function render() {
	            ...
	            var resultInfo = this.props.userMessage.resultInfo;

	            return React.createElement(
	                'div',
	                { className: 'module-modify-password clearfix' },
	                React.createElement(
	                    'p',
	                    { className: "head" + (show ? ' header' : ''), onClick: function onClick(e) {
	                            return _this2.show();
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'label',
	                                { key: 'label', className: 'label' },
	                                '原始密码'
	                            ),
	                            React.createElement('input', { type: 'password', className: "input" + (pass.old ? ' red-border' : ''), onBlur: function onBlur(e) {
	                                    return _this2.blur(e, "old");
	                                } }),
	                            React.createElement(
	                                'p',
	                                { className: "hint" + (pass.old ? ' verify' : '') },
	                                pass.oldName
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement('input', { type: 'password', className: "input" + (pass.newOne ? ' red-border' : ''), onBlur: function onBlur(e) {
	                                    return _this2.blur(e, "newOne");
	                                } }),
	                            React.createElement(
	                                'p',
	                                { className: "hint" + (pass.newOne ? ' verify' : '') },
	                                pass.newOneName
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement('input', { type: 'password', className: "input" + (pass.newTwo ? ' red-border' : ''), onBlur: function onBlur(e) {
	                                    return _this2.blur(e, "newTwo");
	                                } }),
	                            React.createElement(
	                                'p',
	                                { className: "hint" + (pass.newTwo ? ' verify' : '') },
	                                pass.newTwoName
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement('input', { type: 'text', className: 'input code', maxLength: '4', onBlur: function onBlur(e) {
	                                    return _this2.blur(e, "verifyCode");
	                                } }),
	                            React.createElement(
	                                'p',
	                                { className: "hint" + (pass.code ? ' verify' : '') },
	                                pass.codeName
	                            ),
	                            React.createElement('img', { src: src, className: 'CodeImg', ref: 'codeImg',
	                                onClick: function onClick(e) {
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            var src = nextProps.userMessage.src;
	            this.setState({
	                src: src
	            });
	        }
	        ...
	        value: function blur(e, name) {
	            ...
	            var pass = _state2.pass;

	            var newPas = {};
	            var value = util.base64encode(e.target.value),
	                newValue = "";
	        ...
	        value: function handleClick() {
	            var src = "/scoreManagement/user/createCaptcha?" + new Date().getTime();
	            this.setState({
	                src: src
	            });
	        }
	        ...
	        value: function submitPassword() {
	            ...
	            var oldPass = _state3.oldPass;
	            var pass = _state3.pass;
	            var newPass = _state3.newPass;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./modify-password.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./modify-password.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-modify-password {\n  margin-top: 20px;\n  width: 100%;\n  float: left;\n  min-width: 800px;\n  border: 1px solid #ededed;\n  border-radius: 3px; }\n  .module-modify-password input, .module-modify-password button, .module-modify-password select, .module-modify-password textarea {\n    outline: none;\n    border: none; }\n  .module-modify-password textarea {\n    resize: none; }\n  .module-modify-password .head {\n    padding: 5px 20px;\n    cursor: pointer;\n    background-color: #f8f8f8;\n    border-radius: 3px;\n    color: #343434;\n    font-size: 12px;\n    padding-left: 20px;\n    margin: 0;\n    line-height: 20px; }\n  .module-modify-password .header {\n    border-bottom: 1px solid #ededed; }\n  .module-modify-password .div {\n    width: 50%;\n    padding: 0 25%;\n    display: none; }\n  .module-modify-password .ul {\n    list-style-type: none;\n    margin: 0;\n    padding: 0;\n    font-size: 14px; }\n  .module-modify-password .li {\n    float: left;\n    width: 100%;\n    margin-top: 20px;\n    line-height: 30px; }\n  .module-modify-password .label {\n    float: left;\n    text-align: right;\n    width: 80px;\n    margin-right: 5px;\n    color: #333; }\n  .module-modify-password .input {\n    width: 250px;\n    height: 30px;\n    float: left;\n    border: 1px solid #b5b5b5;\n    border-radius: 3px;\n    color: #b5b5b5;\n    font-size: 12px;\n    line-height: 30px; }\n  .module-modify-password .p {\n    margin: 0;\n    padding: 0; }\n  .module-modify-password .a {\n    text-decoration: none;\n    color: #fff;\n    text-align: center;\n    font-size: 14px;\n    width: 100px;\n    height: 30px;\n    border-radius: 3px;\n    float: left;\n    line-height: 30px;\n    margin: 20px 0 20px 85px; }\n  .module-modify-password .span {\n    display: none;\n    color: #ff331a; }\n  .module-modify-password .after {\n    display: inline-block; }\n  .module-modify-password .submit {\n    background-color: #e84c3d; }\n  .module-modify-password .return {\n    background-color: #45bed9; }\n  .module-modify-password .CodeImg {\n    cursor: pointer; }\n  .module-modify-password .hint {\n    padding: 0;\n    float: left;\n    width: 100%;\n    margin: 5px 0 0 85px;\n    font-size: 12px;\n    color: #e74c3c;\n    display: none;\n    line-height: normal; }\n  .module-modify-password .red-border {\n    border: 1px solid #e74c3c; }\n  .module-modify-password .verify {\n    display: block; }\n  .module-modify-password .iconfont {\n    font-family: \"iconfont\" !important;\n    font-size: 13px;\n    font-style: normal;\n    -webkit-font-smoothing: antialiased;\n    -webkit-text-stroke-width: 0.2px;\n    -moz-osx-font-smoothing: grayscale; }\n  .module-modify-password .spanArrows:before {\n    color: #ededed;\n    content: \"\\E627\";\n    float: right;\n    margin-right: 20px; }\n  .module-modify-password .code {\n    width: 140px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function postPassWord(data) {
	    var url = '/scoreManagement/user/updatePassword';
	    return util.postRequest(url, data);
	}
	...
	module.exports = {
	    userInfoList: function userInfoList() {
	        //获取用户基本信息
	    ...
	    verifyCode: function verifyCode(data) {
	        ...
	        return function (dispatch) {
	            return postVerify(info).then(function (res) {
	                res.json().then(function (json) {
	                    if (json.result !== "0") {
	                        var newSrc = "/scoreManagement/user/createCaptcha?" + new Date().getTime();
