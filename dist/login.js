...
/***/ function(module, exports, __webpack_require__) {
	...
	var ForgetPassword = _require.ForgetPassword;

	var _require2 = __webpack_require__(297);

	var _refreshSrc = _require2.refreshSrc;
	var _postVerifyCode = _require2.postVerifyCode;
	var login = _require2.login;
	var _sendEmail = _require2.sendEmail;

	var _require3 = __webpack_require__(283);

	var scorewebStore = _require3.scorewebStore;

	var _require4 = __webpack_require__(305);

	var Provider = _require4.Provider;
	var connect = _require4.connect;

	var _require5 = __webpack_require__(284);

	var createStore = _require5.createStore;
	var applyMiddleware = _require5.applyMiddleware;
	...
	var component = function (_React$Component) {
	    ...
	    _createClass(component, [{
	        ...
	        value: function render() {
	            ...
	            var src = this.props.login.src;
	            var dispatch = this.props.dispatch;
	            var _state = this.state;
	            var getShow = _state.getShow;
	            var goEmail = _state.goEmail;
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: "module-login" + (getShow ? ' show' : '') },
	                    React.createElement(
	                        'p',
	                        { className: 'p' },
	                        React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'a',
	                                {
	                                    href: 'http://www.hbc315.com/hbc/trial.jsp', className: 'try' },
	                                '申请试用'
	                            )
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement('input', { type: 'text', className: 'input', placeholder: '请输入用户名',
	                            ref: 'name' })
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'div' },
	                        React.createElement('span', null),
	                        React.createElement('input', { type: 'password', className: 'input', placeholder: '请输入密码',
	                            ref: 'passWord' })
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'div' },
	                        React.createElement('span', null),
	                        React.createElement('input', { type: 'text', className: 'input', maxLength: '4',
	                            placeholder: '请输入验证码', ref: 'code',
	                            onChange: function onChange(e) {
	                                return _this2.codeChange(e);
	                            } }),
	                        React.createElement('img', { src: src,
	                            className: 'img',
	                            onClick: function onClick(e) {
	                                return _this2.imgClick();
	                            } })
	                    ),
	                    React.createElement(
	                        'a',
	                        { href: 'javascript:;', className: 'submit', onClick: function onClick(e) {
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'a',
	                            { href: 'javascript:;',
	                                className: 'bottom-forget', onClick: function onClick(e) {
	                                    return _this2.forgetPassword();
	                                } },
	                            '忘记密码?'
	                        )
	                    )
	                ),
	                React.createElement(ForgetPassword, { src: src,
	                    getShow: getShow,
	                    goEmail: goEmail,
	                    refreshSrc: function refreshSrc(src) {
	                        return dispatch(_refreshSrc(src));
	                    },
	                    postVerifyCode: function postVerifyCode(data) {
	                        return dispatch(_postVerifyCode(data));
	                    },
	                    sendEmail: function sendEmail(data) {
	                        return dispatch(_sendEmail(data));
	                    } })
	            );
	        }
	    }, {
	        ...
	        value: function componentDidMount() {
	            ...
	            window.onhashchange = function (event) {
	                console.log(1, '***');
	                var newHash = util.getHash(event.newURL);
	                var oldHash = util.getHash(event.oldURL);
	                var page = false;
	                var pag = true;
	        ...
	        value: function imgClick() {
	            ...
	            dispatch(_refreshSrc());
	        }
	    }, {
	        key: 'submit',
	        value: function submit() {
	            var name = this.refs.name.value;
	            var passWord = util.base64encode(this.refs.passWord.value);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./login.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./login.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html, body {\n  width: 100%;\n  height: 100%; }\n\na {\n  text-decoration: none; }\n\n.main {\n  width: 100%;\n  min-width: 1024px;\n  background: url(" + __webpack_require__(466) + ") 0 0 no-repeat;\n  background-size: 100% 100%;\n  position: fixed;\n  top: 0;\n  bottom: 0; }\n  .main .module-login {\n    width: 400px;\n    position: relative;\n    float: left;\n    left: 50%;\n    margin-top: 130px;\n    margin-left: -200px;\n    display: none; }\n    .main .module-login .p {\n      width: 300px;\n      float: left;\n      margin: 0;\n      padding: 0;\n      margin-left: 40px;\n      font-size: 20px;\n      color: #fff; }\n    .main .module-login .spano {\n      float: left; }\n    .main .module-login .spant {\n      float: right;\n      font-size: 16px;\n      line-height: 28px; }\n    .main .module-login .try {\n      color: #e74c3c; }\n    .main .module-login .div {\n      width: 300px;\n      margin: 20px 40px 0 40px;\n      height: 40px;\n      background-color: #fff;\n      float: left;\n      border-radius: 5px; }\n    .main .module-login .submit {\n      width: 300px;\n      height: 40px;\n      margin: 20px 40px 0 40px;\n      color: #fff;\n      background-color: #e74c3c;\n      font-style: 16px;\n      line-height: 40px;\n      text-align: center;\n      float: left;\n      border-radius: 5px; }\n    .main .module-login .bottom {\n      width: 300px;\n      margin-left: 40px;\n      float: left;\n      color: #b5b5b5;\n      font-size: 12px; }\n    .main .module-login .bottom-forget {\n      float: right;\n      color: #29c7ca; }\n    .main .module-login .input {\n      font-size: 14px;\n      height: 20px;\n      margin-top: 10px;\n      border: none;\n      line-height: 20px;\n      padding-left: 10px;\n      outline: medium; }\n    .main .module-login .img {\n      float: right;\n      height: 40px;\n      background-size: 100% 100%;\n      cursor: pointer; }\n  .main .show {\n    display: block; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "js/page/login/images/background1a666d19.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require5 = __webpack_require__(470);

	var GoEmail = _require5.GoEmail;

	var store = createStore(scorewebStore, applyMiddleware(thunk));

	var ForgetPassword = exports.ForgetPassword = function (_React$Component) {
	    _inherits(ForgetPassword, _React$Component);

	    function ForgetPassword(props) {
	        _classCallCheck(this, ForgetPassword);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ForgetPassword).call(this, props));

	        var hash = location.hash.replace("#", "");
	        var goEmail = _this.props.goEmail;
	    ...
	    _createClass(ForgetPassword, [{
	        ...
	        value: function render() {
	            ...
	            var getShow = _props.getShow;
	            var goEmail = _props.goEmail;
	            var emailName = this.state.emailName;
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: "module-forget-password" + (getShow ? '' : goEmail ? '' : ' show') },
	                    React.createElement(
	                        'p',
	                        { className: 'p' },
	                        '忘记密码'
	                    ...
	                    React.createElement(
	                        ...
	                        { className: 'div' },
	                        React.createElement('span', null),
	                        React.createElement('input', { type: 'text', className: 'input', placeholder: '请输入您的邮箱',
	                            ref: 'email', onBlur: function onBlur(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./forget-password.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./forget-password.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-forget-password {\n  width: 420px;\n  position: relative;\n  float: left;\n  left: 50%;\n  margin-top: 130px;\n  margin-left: -210px;\n  display: none; }\n  .module-forget-password .div {\n    width: 300px;\n    margin-top: 20px;\n    height: 40px;\n    background-color: #fff;\n    float: left;\n    border-radius: 5px; }\n  .module-forget-password .submit {\n    width: 100px;\n    height: 40px;\n    margin: 20px 0 0 20px;\n    color: #fff;\n    background-color: #e74c3c;\n    font-size: 14px;\n    line-height: 40px;\n    text-align: center;\n    float: left;\n    border-radius: 5px; }\n  .module-forget-password .bottom {\n    width: 300px;\n    margin-left: 40px;\n    float: left;\n    color: #b5b5b5;\n    font-size: 12px; }\n  .module-forget-password .bottom-forget {\n    float: right;\n    color: #29c7ca; }\n  .module-forget-password .input {\n    font-size: 14px;\n    height: 20px;\n    margin-top: 10px;\n    border: none;\n    line-height: 20px;\n    outline: medium; }\n  .module-forget-password .img {\n    float: right;\n    height: 40px;\n    background-size: 100% 100%;\n    cursor: pointer; }\n  .module-forget-password .p {\n    font-size: 20px;\n    color: #fff;\n    text-align: center;\n    margin: 0; }\n  .module-forget-password .error {\n    font-size: 14px;\n    color: #e74c3c;\n    margin-top: 10px;\n    float: left; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoEmail = exports.GoEmail = function (_React$Component) {
	    _inherits(GoEmail, _React$Component);

	    function GoEmail(props) {
	        _classCallCheck(this, GoEmail);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GoEmail).call(this, props));

	        _this.state = {};
	        return _this;
	    }

	    _createClass(GoEmail, [{
	        key: 'render',
	        value: function render() {
	            var _this2 = this;

	            var goEmail = this.props.goEmail;

	            return React.createElement(
	                'div',
	                { className: "module-go-email" + (goEmail ? ' show' : '') },
	                React.createElement(
	                    'p',
	                    { className: 'title' },
	                    '我们已经向您的注册邮箱457117157@qq.com发送了一份密码找回邮件,请您注意接收邮件'
	                ),
	                React.createElement(
	                    'a',
	                    { className: 'submit', href: 'javascript:;' },
	                    '去邮箱接收邮件'
	                ),
	                React.createElement(
	                    'p',
	                    { className: 'text' },
	                    '请注意查收邮件,并按照邮件中的提示操作,完成安全认证.没有收到邮件?',
	                    React.createElement(
	                        'a',
	                        { className: 'a', href: 'javascript:;', onClick: function onClick(e) {
	                                return _this2.aClick();
	                            } },
	                        '重新发送'
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./go-email.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./go-email.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-go-email {\n  width: 500px;\n  position: relative;\n  float: left;\n  left: 50%;\n  margin-top: 130px;\n  margin-left: -250px;\n  display: none; }\n  .module-go-email .title {\n    color: #fff;\n    font-size: 16px;\n    float: left; }\n  .module-go-email .submit {\n    width: 120px;\n    height: 40px;\n    color: #fff;\n    background-color: #e74c3c;\n    font-size: 14px;\n    line-height: 40px;\n    text-align: center;\n    float: left;\n    border-radius: 5px; }\n  .module-go-email .text {\n    font-size: 12px;\n    color: #333;\n    float: left; }\n  .module-go-email .a {\n    color: #e74c3c; }\n  .module-go-email .show {\n    display: block; }\n", ""]);
