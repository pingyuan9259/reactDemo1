...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require4 = __webpack_require__(488);

	var ChartBargroup = _require4.ChartBargroup;

	var _require5 = __webpack_require__(303);

	var _leftNavFirst = _require5.leftNavFirst;
	var _leftNavNext = _require5.leftNavNext;
	var achieveModuleUsedData = _require5.achieveModuleUsedData;
	...
	var component = function (_React$Component) {
	    ...
	    _createClass(component, [{
	        ...
	        value: function render() {
	            ...
	            var bargroupData = _props.bargroupData;
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(Breadcrumb, { breadcrumbMsg: '统计详情' })
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'content' },
	                        React.createElement(ChartBargroup, { bargroupData: bargroupData })
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./statistic-details.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./statistic-details.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChartBargroup = exports.ChartBargroup = function (_React$Component) {
	    _inherits(ChartBargroup, _React$Component);

	    function ChartBargroup(props) {
	        _classCallCheck(this, ChartBargroup);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ChartBargroup).call(this, props));
	    }

	    _createClass(ChartBargroup, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                'div',
	                { className: 'module-chart-bargroup' },
	                React.createElement('div', { id: 'chart-bargroup', ref: 'chartBody' })
	            );
	        }
	    }, {
	        key: 'componentDidMount',
	        ...
	        key: 'componentWillReceiveProps',
	        value: function componentWillReceiveProps(nextProps) {
	            var bargroupData = nextProps.bargroupData;

	            var barData = [];
	            var legend = [];
	            for (var i = 0, len = bargroupData.moduleData.length; i < len; i++) {
	                var data = bargroupData.moduleData[i];
	                var group = {
	                    type: 'bar',
	                    barGap: '15%',
	                    barCategoryGap: '50%'
	            ...
	            if (this.refs.chartBody && bargroupData.dateData) {
	                var formatDateData = [];
	                for (var _i = 0, _len = bargroupData.dateData.length; _i < _len; _i++) {
	                    formatDateData.push(util.getLocalTime(bargroupData.dateData[_i], 'date'));
	                }
	                chartBar.setOption({
	                    title: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./chart-bargroup.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./chart-bargroup.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-chart-bargroup {\n  width: 100%; }\n  .module-chart-bargroup #chart-bargroup {\n    width: 100%;\n    height: 500px; }\n", ""]);
