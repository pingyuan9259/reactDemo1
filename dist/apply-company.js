...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require4 = __webpack_require__(269);
	...
	var _require7 = __webpack_require__(282);

	var applyCompanyList = _require7.applyCompanyList;
	...
	var columns = [{ name: 'id', desc: '序号', width: 16 }, { name: 'applyTime', desc: '申请时间', width: 16 }, { name: 'company', desc: '公司名称', width: 16 }, { name: 'companyAddress', desc: '公司地址', width: 16 }, { name: 'name', desc: '联系人姓名', width: 16 }, { name: 'mobile', desc: '联系人手机号', width: 16 }, { name: 'email', desc: '联系人邮箱', width: 16 }, { name: 'companyType', desc: '公司类型', width: 16 }, { name: 'from', desc: '来源', width: 16 }, { name: 'businessLicence', desc: '营业执照图片' }];
	    ...
	    _createClass(component, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                'div',
	                { className: 'module-apply-company' },
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'apply-table container' },
	                    React.createElement(
	                        'div',
	                        { className: 'breadcrumb-container' },
	                        React.createElement(Breadcrumb, { breadcrumbMsg: '试用申请客户' })
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'content' },
	                        React.createElement(
	                            'div',
	                            { className: 'company-queryBox' },
	                            React.createElement(
	                                'a',
	                                { href: '/scoreweb/company/exportList', className: 'btn-teem' },
	                                '批量倒出'
	                            )
	                        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./apply-company.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./apply-company.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-apply-company .apply-table {\n  position: absolute;\n  top: 75px;\n  left: 200px;\n  right: 0;\n  z-index: -1; }\n\n.module-apply-company .company-queryBox {\n  margin-bottom: 20px;\n  float: left; }\n\n.module-apply-company .btn-teem {\n  width: 100px;\n  height: 30px;\n  font-size: 12px;\n  color: #fff;\n  background-color: #e74c3c;\n  border-radius: 3px;\n  float: left;\n  text-align: center;\n  line-height: 30px; }\n\n.module-apply-company .content {\n  box-sizing: border-box; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function applyCompany(data) {
	    var url = '/scoreManagement/company/getApplyList';
	...
	module.exports = {
	    applyCompanyList: function applyCompanyList(requestData) {
	        return function (dispath) {
	            return applyCompany(requestData).then(function (data) {
