...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require4 = __webpack_require__(461);

	var ProgressBar = _require4.ProgressBar;

	var _require5 = __webpack_require__(278);

	var Pages = _require5.Pages;

	var _require6 = __webpack_require__(304);

	var _leftNavFirst = _require6.leftNavFirst;
	var _leftNavNext = _require6.leftNavNext;
	var achieveProgressBarData = _require6.achieveProgressBarData;
	...
	var component = function (_React$Component) {
	    ...
	    _createClass(component, [{
	        ...
	        value: function render() {
	            ...
	            var progressBarData = _props.progressBarData;
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(Breadcrumb, { breadcrumbMsg: '预警' })
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'content' },
	                        React.createElement(ProgressBar, { progressBarData: progressBarData })
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./early-warning.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./early-warning.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	var ProgressBar = exports.ProgressBar = function (_React$Component) {
	    ...
	    _createClass(ProgressBar, [{
	        ...
	        value: function createBar() {
	            var barNode = [];
	            var progressBarData = this.props.progressBarData;

	            if (!progressBarData) {
	                progressBarData = [];
	            }
	            for (var i = 0, len = progressBarData.length; i < len; i++) {
	                var data = progressBarData[i];
	                var status = '';
	                var color = '';
	                var warningPercent = Math.ceil(data.thresholdValue / data.total * 100);
	                var usedPercent = Math.ceil(data.thresholdUsed / data.total * 100);
	                switch (data.status) {
	                    case 0:
	                        status = '正常';
	                        color = '#2AC5C9';
	                ...
	                barNode.push(React.createElement(
	                    'li',
	                    { className: 'item', key: 'progressBar' + i },
	                    React.createElement(
	                        'div',
	                        { className: 'bar-background' },
	                        React.createElement(
	                            'div',
	                            { className: 'marking-container' },
	                            React.createElement(
	                                'span',
	                                { className: 'marking' },
	                                usedPercent,
	                        ...
	                        React.createElement(
	                            'div',
	                            { className: 'bar-value-container' },
	                            React.createElement('div', { className: 'bar-value', style: { width: usedPercent + '%', backgroundColor: color } })
	                        ),
	                        React.createElement('span', { className: 'warning-mark', style: { left: warningPercent + '%' } }),
	                        React.createElement(
	                            'span',
	                            { className: 'status' },
	                            status
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement('span', { className: 'edit' }),
	                        React.createElement(
	                            'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./progress-bar.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./progress-bar.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".module-progress-bar .bar-container {\n  display: inline-block;\n  width: 100%; }\n  .module-progress-bar .bar-container .item {\n    margin-bottom: 40px; }\n    .module-progress-bar .bar-container .item .bar-background {\n      padding: 5px;\n      background-color: #eee;\n      width: 96%;\n      height: 10px;\n      border-radius: 20px;\n      position: relative; }\n      .module-progress-bar .bar-container .item .bar-background .marking-container {\n        width: 32px;\n        text-align: center;\n        margin-top: -5px; }\n        .module-progress-bar .bar-container .item .bar-background .marking-container .marking {\n          color: #999;\n          font-size: 12px; }\n      .module-progress-bar .bar-container .item .bar-background .bar-value-container {\n        width: 95%;\n        position: absolute;\n        left: 40px;\n        top: 5px; }\n        .module-progress-bar .bar-container .item .bar-background .bar-value-container .bar-value {\n          height: 10px;\n          border-radius: 10px; }\n      .module-progress-bar .bar-container .item .bar-background .warning-mark {\n        width: 2px;\n        height: 20px;\n        position: absolute;\n        top: 0;\n        margin-left: -1px;\n        background-color: #EABDB9; }\n      .module-progress-bar .bar-container .item .bar-background .status {\n        color: #999;\n        font-size: 12px;\n        position: absolute;\n        top: 0;\n        right: -35px; }\n    .module-progress-bar .bar-container .item .label {\n      width: 97%;\n      font-size: 12px;\n      padding-top: 5px;\n      color: #999; }\n      .module-progress-bar .bar-container .item .label .proportion {\n        float: right; }\n      .module-progress-bar .bar-container .item .label .edit {\n        float: right;\n        margin-left: 5px;\n        cursor: pointer; }\n      .module-progress-bar .bar-container .item .label .edit:after {\n        color: #29c7ca;\n        font-family: \"iconfont\" !important;\n        font-size: 14px;\n        font-style: normal;\n        -webkit-font-smoothing: antialiased;\n        -webkit-text-stroke-width: 0.2px;\n        -moz-osx-font-smoothing: grayscale;\n        content: \"\\E64B\"; }\n  .module-progress-bar .bar-container .item:first-child {\n    margin-top: 20px; }\n  .module-progress-bar .bar-container .item:last-child {\n    margin-bottom: 20px; }\n", ""]);
