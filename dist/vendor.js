...
/******/ 			script.src = __webpack_require__.p + "" + ({"0":"apply-company","1":"business-list","2":"create-company","3":"early-warning","4":"login","5":"mod-manage","6":"query-statistics","7":"reset-password","8":"statistic-details","9":"user-info","10":"user-logs"}[chunkId]||chunkId) + ".chunk.js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "font/iconfont37e90027.eot";

/***/ },
/* 8 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "font/iconfont23c499f5.woff";

/***/ },
/* 9 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "font/iconfont07dd45e0.ttf";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var eventEmitter = __webpack_require__(173);
	...
	module.exports = {
	    ...
	    //pingyuan
	    objToUrlString: function objToUrlString(url, obj) {
	    ...
	    getLocalTime: function getLocalTime(time, type) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var d = __webpack_require__(174),
	    callable = __webpack_require__(187),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseClone = __webpack_require__(193),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNative = __webpack_require__(199),
	    ...
	    isObject = __webpack_require__(202),
	    shimKeys = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNative = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bufferClone = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isLength = __webpack_require__(207),
	    isObjectLike = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObjectLike = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isStrictComparable = __webpack_require__(248),
	    pairs = __webpack_require__(249);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayCopy = __webpack_require__(194),
	    getLength = __webpack_require__(205),
	    isLength = __webpack_require__(207),
	    values = __webpack_require__(258);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseValues = __webpack_require__(259),
	    keys = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.listFrame = listFrame;
	exports.listFrameActive = listFrameActive;
	exports.listFrameDiv = listFrameDiv;
	exports.listFrameDivRemove = listFrameDivRemove;
	exports.listFrameDivRage = listFrameDivRage;
	exports.listFrameLiRemove = listFrameLiRemove;
	exports.listFrameLiAdd = listFrameLiAdd;
	exports.userMessage = userMessage;
	exports.modifyReturn = modifyReturn;
	exports.inputCode = inputCode;
	exports.tryCode = tryCode;
	exports.queryBoxCheckbox = queryBoxCheckbox;
	exports.leftNavFirst = leftNavFirst;
	exports.leftNavNext = leftNavNext;
	exports.leftNavRole = leftNavRole;
	exports.windowKeyDown = windowKeyDown;
	exports.updateInfo = updateInfo;
	exports.userInfoList = userInfoList;
	exports.modifySelfInfo = modifySelfInfo;
	exports.verifyOldPassWord = verifyOldPassWord;
	exports.verifyCode = verifyCode;
	exports.modifyPassWord = modifyPassWord;
	exports.boxyShow = boxyShow;
	exports.boxyHide = boxyHide;
	exports.maskShow = maskShow;
	exports.maskHide = maskHide;
	exports.infoFormSubmit = infoFormSubmit;
	exports.btnGroupSure = btnGroupSure;
	exports.btnGroupModify = btnGroupModify;
	exports.btnGroupDelete = btnGroupDelete;
	 ...
	 */
	//list-frame组件
	var LIST_FRAME = exports.LIST_FRAME = 'LIST_FRAME';
	function listFrame(listFrame) {
	    return {
	        type: LIST_FRAME,
	        listFrame: listFrame
	    };
	}
	var LIST_FRAME_ACTIVE = exports.LIST_FRAME_ACTIVE = 'LIST_FRAME_ACTIVE';
	function listFrameActive(active) {
	    return {
	        type: LIST_FRAME_ACTIVE,
	        active: active
	    };
	}
	var LIST_FRAME_DIV = exports.LIST_FRAME_DIV = 'LIST_FRAME_DIV';
	function listFrameDiv(listDiv) {
	    return {
	        type: LIST_FRAME_DIV,
	        listDiv: listDiv
	    };
	}
	var LIST_FRAME_DIV_REMOVE = exports.LIST_FRAME_DIV_REMOVE = 'LIST_FRAME_DIV_REMOVE';
	function listFrameDivRemove(index) {
	    return {
	        type: LIST_FRAME_DIV_REMOVE,
	        index: index
	    };
	}
	var LIST_FRAME_DIV_PAGE = exports.LIST_FRAME_DIV_PAGE = 'LIST_FRAME_DIV_PAGE';
	function listFrameDivRage(page) {
	    return {
	        type: LIST_FRAME_DIV_PAGE,
	        page: page
	    };
	}
	var LIST_FRAME_LI_REMOVE = exports.LIST_FRAME_LI_REMOVE = 'LIST_FRAME_LI_REMOVE';
	function listFrameLiRemove(indexLi) {
	    return {
	        type: LIST_FRAME_LI_REMOVE,
	        indexLi: indexLi
	    };
	}
	var LIST_REAME_LI_ADD = exports.LIST_REAME_LI_ADD = 'LIST_REAME_LI_ADD';
	function listFrameLiAdd(ObjLi) {
	    return {
	...
	var MODIFY_RETURN = exports.MODIFY_RETURN = 'MODIFY_RETURN';
	function modifyReturn(result) {
	    return {
	        type: MODIFY_RETURN,
	        result: result
	    };
	}
	var INPUT_CODE = exports.INPUT_CODE = 'INPUT_CODE';
	...
	var TRY_CODE = exports.TRY_CODE = 'TRY_CODE';
	function tryCode(newSrc) {
	    return {
	        type: TRY_CODE,
	        newSrc: newSrc
	    };
	...
	//query-box组件checkbox
	var QUERY_BOX_CHECKBOX = exports.QUERY_BOX_CHECKBOX = 'QUERY_BOX_CHECKBOX';
	function queryBoxCheckbox(active) {
	    return {
	...
	//left-nav组件选中
	var LEFT_NAV_FIRST = exports.LEFT_NAV_FIRST = 'LEFT_NAV_FIRST';
	var LEFT_NAV_NEXT = exports.LEFT_NAV_NEXT = 'LEFT_NAV_NEXT';
	var LEFT_NAV_ROLE = exports.LEFT_NAV_ROLE = 'LEFT_NAV_ROLE';
	function leftNavFirst(selectFirst) {
	    return {
	        type: LEFT_NAV_FIRST,
	        selectFirst: selectFirst
	    };
	}
	function leftNavNext(selectNext) {
	    return {
	        type: LEFT_NAV_NEXT,
	...
	function updateInfo(data) {
	    return function (dispatch) {
	        return fetchSecretSauce().then(function (sauce) {
	...
	function userInfoList() {
	    return function (dispatch) {
	        return getSelfInfo().then(function (res) {
	...
	function modifySelfInfo(data) {
	    var info = data;
	    return function (dispatch) {
	        return postSelfInfo(info).then(function (res) {
	            res.json().then(function (json) {});
	        });
	    };
	}
	...
	function verifyOldPassWord(data) {
	    var info = data;
	    return function (dispatch) {
	        return postOldPassWord(info).then(function (res) {
	            res.json().then(function (json) {
	...
	function verifyCode(data) {
	    var info = data;
	    return function (dispatch) {
	        return postVerify(info).then(function (res) {
	            res.json().then(function (json) {
	                if (json.result !== "0") {
	                    var newSrc = "/scoreweb/user/createCaptcha?" + new Date().getTime();
	...
	function modifyPassWord(data) {
	    var info = data;
	    return function (dispatch) {
	        return postPassWord(info).then(function (res) {
	            res.json().then(function (json) {
	                console.log(json);
	            });
	        });
	 ...
	 */
	//boxyAction
	var BOXY_SHOW = exports.BOXY_SHOW = 'BOXY_SHOW';
	function boxyShow(showMsg) {
	    return {
	        type: BOXY_SHOW,
	        showMsg: showMsg
	    };
	}
	var BOXY_HIDE = exports.BOXY_HIDE = 'BOXY_HIDE';
	function boxyHide() {
	    return {
	        type: BOXY_HIDE
	    };
	...
	//maskAction
	var MASK_SHOW = exports.MASK_SHOW = 'MASK_SHOW';
	function maskShow(showMsg) {
	    return {
	        type: MASK_SHOW,
	        showMsg: showMsg
	    };
	}
	var MASK_HIDE = exports.MASK_HIDE = 'MASK_HIDE';
	function maskHide() {
	    return {
	        type: MASK_HIDE
	    };
	...
	// infoFormSubmit
	var INFOFORM_SUBMIT = exports.INFOFORM_SUBMIT = 'INFOFORM_SUBMIT';
	function infoFormSubmit(submitList) {
	    return {
	...
	// btnGroupAction
	var BTN_GROUP_SURE = exports.BTN_GROUP_SURE = 'BTN_GROUP_SURE';
	function btnGroupSure(btnMsg) {
	    return {
	        type: BTN_GROUP_SURE,
	        btnMsg: btnMsg
	    };
	}
	var BTN_GROUP_MODIFY = exports.BTN_GROUP_MODIFY = 'BTN_GROUP_MODIFY';
	function btnGroupModify(btnMsg) {
	    return {
	        type: BTN_GROUP_MODIFY,
	        btnMsg: btnMsg
	    };
	}
	var BTN_GROUP_DELETE = exports.BTN_GROUP_DELETE = 'BTN_GROUP_DELETE';
	function btnGroupDelete(btnMsg) {
	    return {
	...
	// tabsAction
	var TABS_SWITCH = exports.TABS_SWITCH = 'TABS_SWITCH';
	function tabsSwitch(tabsData, i) {
	    return {
	        type: TABS_SWITCH,
	        index: i,
	        tabsData: tabsData
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.scorewebStore = undefined;
	...
	var RESET_PASSWORD_SRC = _require.RESET_PASSWORD_SRC;
	var RESET_VERIFY_CODE = _require.RESET_VERIFY_CODE;

	function resetPassword() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { src: '/scoreManagement/user/createCaptcha', code: true } : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case RESET_PASSWORD_SRC:
	            var src = { src: '/scoreManagement/user/createCaptcha?' + new Date().getTime() };
	            return Object.assign({}, state, src);
	        case RESET_VERIFY_CODE:
	            var code = { code: action.code };
	...
	var REFRESH_SRC = _require2.REFRESH_SRC;
	var VERIFY_CODE = _require2.VERIFY_CODE;
	...
	var COMPANY_MESSAGE = _require3.COMPANY_MESSAGE;


	function showCompany() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { companyList: {} } : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case COMPANY_MESSAGE:
	            var list = { companyList: action.list };
	...
	var USER_MESSAGE = _require4.USER_MESSAGE;
	var INPUT_CODE = _require4.INPUT_CODE;
	var MODIFY_RETURN = _require4.MODIFY_RETURN;
	var TRY_CODE = _require4.TRY_CODE;

	function userMessage() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { listMessage: {}, code: '', resultInfo: '', src: '/scoreManagement/user/createCaptcha' } : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case USER_MESSAGE:
	            var messageList = { listMessage: action.messageList };
	            return Object.assign({}, state, messageList);
	        case INPUT_CODE:
	            var code = { code: action.code };
	            return Object.assign({}, state, code);
	        case MODIFY_RETURN:
	            var result = { resultInfo: action.result };
	            return Object.assign({}, state, result);
	        case TRY_CODE:
	            var newSrc = { src: action.newSrc };
	...
	var _require5 = __webpack_require__(281);

	var LIST_FRAME = _require5.LIST_FRAME;
	var LIST_FRAME_ACTIVE = _require5.LIST_FRAME_ACTIVE;
	var LIST_FRAME_DIV = _require5.LIST_FRAME_DIV;
	var LIST_FRAME_DIV_REMOVE = _require5.LIST_FRAME_DIV_REMOVE;
	var LIST_FRAME_DIV_PAGE = _require5.LIST_FRAME_DIV_PAGE;
	var LIST_FRAME_LI_REMOVE = _require5.LIST_FRAME_LI_REMOVE;
	var LIST_REAME_LI_ADD = _require5.LIST_REAME_LI_ADD;

	function listFrame() {
	    var _list, _listLi;

	    var state = arguments.length <= 0 || arguments[0] === undefined ? { listFrame: [], divList: [], pageLen: 2, page: 1, active: false } : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case LIST_FRAME:
	            var listFrame = { listFrame: action.listFrame };
	            return Object.assign({}, state, listFrame);
	        case LIST_FRAME_ACTIVE:
	            var Active = { active: action.active };
	            return Object.assign({}, state, Active);
	        case LIST_FRAME_DIV:
	            var listDiv = action.listDiv;
	            var list = _.cloneDeep(state.divList);
	            (_list = list).push.apply(_list, _toConsumableArray(listDiv));
	            list = _.uniqBy(list, 'name');
	            var lfdList = { divList: list };
	            return Object.assign({}, state, lfdList);
	        case LIST_FRAME_DIV_REMOVE:
	            var index = action.index;
	            var copyList = _.cloneDeep(state.divList);
	            copyList.splice(index, 1);
	            var newCopyList = { divList: copyList };
	        ...
	        case LIST_FRAME_LI_REMOVE:
	            var indexLi = action.indexLi;
	            var liList = _.cloneDeep(state.listFrame);
	            liList.splice(indexLi, 1);
	            var newLiList = { listFrame: liList };
	            return Object.assign({}, state, newLiList);
	        case LIST_REAME_LI_ADD:
	            var objLi = action.ObjLi;
	            var listLi = _.cloneDeep(state.listFrame);
	            (_listLi = listLi).push.apply(_listLi, _toConsumableArray(objLi));
	            listLi = _.sortBy(listLi, 'id');
	            var newListLi = { listFrame: listLi };
	...
	var QUERY_BOX_CHECKBOX = _require6.QUERY_BOX_CHECKBOX;

	function queryBoxCheckbox() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { active: null } : arguments[0];
	    var action = arguments[1];
	...
	var LEFT_NAV_FIRST = _require7.LEFT_NAV_FIRST;
	var LEFT_NAV_NEXT = _require7.LEFT_NAV_NEXT;
	var LEFT_NAV_ROLE = _require7.LEFT_NAV_ROLE;

	function leftNavActive() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { select: [0, 0], role: 0 } : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case LEFT_NAV_FIRST:
	            var stated = { select: action.selectFirst };
	            return Object.assign({}, state, stated);
	        case LEFT_NAV_NEXT:
	            var statedc = { select: action.selectNext };
	            return Object.assign({}, state, statedc);
	        case LEFT_NAV_ROLE:
	            var roled = { role: action.role };
	...
	var _require8 = __webpack_require__(281);

	var BOXY_SHOW = _require8.BOXY_SHOW;
	var BOXY_HIDE = _require8.BOXY_HIDE;
	...
	var _require9 = __webpack_require__(281);

	var MASK_SHOW = _require9.MASK_SHOW;
	var MASK_HIDE = _require9.MASK_HIDE;
	...
	var _require10 = __webpack_require__(281);

	var INFOFORM_SUBMIT = _require10.INFOFORM_SUBMIT;

	function infoFormAction() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? {
	        submitList: {},
	        isPassed: []
	    } : arguments[0];
	...
	var _require11 = __webpack_require__(281);

	var BTN_GROUP_SURE = _require11.BTN_GROUP_SURE;
	var BTN_GROUP_MODIFY = _require11.BTN_GROUP_MODIFY;
	var BTN_GROUP_DELETE = _require11.BTN_GROUP_DELETE;
	...
	var _require12 = __webpack_require__(299);

	var WRITE_SELF_MODULES = _require12.WRITE_SELF_MODULES;
	var WRITE_COMBINE_MODULES = _require12.WRITE_COMBINE_MODULES;

	var _require13 = __webpack_require__(300);

	var WRITE_EVENT_LOG_MANAGEMENT = _require13.WRITE_EVENT_LOG_MANAGEMENT;

	var _require14 = __webpack_require__(301);

	var TABLE_LIST = _require14.TABLE_LIST;
	var BUSINESS_LIST = _require14.BUSINESS_LIST;
	var WRITE_EVENT_LOG = _require14.WRITE_EVENT_LOG;
	...
	function writeTableData() {
	    ...
	    switch (action.type) {
	        ...
	        case WRITE_SELF_MODULES:
	            ...
	            data = {
	                columns: [{ name: 'id', desc: '序号', width: 16 }, { name: 'publishTime', desc: '上线时间', width: 16 }, { name: 'moduleName', desc: '模型名称', width: 16 }, { name: 'type', desc: '适用企业', width: 16 }, { name: 'ks', desc: 'KS值', width: 16 }, { name: 'badGraph', desc: '坏账率曲线图', width: 20 }],
	                list: list,
	                allPage: allPage,
	                page: page
	            };
	        ...
	        case WRITE_COMBINE_MODULES:
	            ...
	            page = action.data.page;
	            data = {
	                columns: [{ name: 'id', desc: '序号2', width: 16 }, { name: 'publishTime', desc: '上线时间2', width: 16 }, { name: 'moduleName', desc: '模型名称2', width: 16 }, { name: 'type', desc: '适用企业2', width: 16 }, { name: 'ks', desc: 'KS值2', width: 16 }, { name: 'badGraph', desc: '坏账率曲线图2', width: 20 }],
	                list: list,
	                allPage: allPage,
	                page: page
	            };
	        ...
	        case WRITE_EVENT_LOG_MANAGEMENT:
	            ...
	            page = action.data.page;
	            data = {
	                columns: [{ name: 'id', desc: '序号', width: 15 }, { name: 'eventStr', desc: '日志事件', width: 18 }, { name: 'username', desc: '用户', width: 15 }, { name: 'description', desc: '日志描述', width: 30 }, { name: 'createTime', desc: '操作时间' }],
	                list: list,
	                allPage: allPage,
	                page: page
	            };
	...
	var _require15 = __webpack_require__(281);

	var TABS_SWITCH = _require15.TABS_SWITCH;
	...
	var _require16 = __webpack_require__(302);

	var WRITE_BAR_DATA = _require16.WRITE_BAR_DATA;

	var _require17 = __webpack_require__(303);

	var WRITE_BARGROUP_DATA = _require17.WRITE_BARGROUP_DATA;

	var _require18 = __webpack_require__(304);

	var WRITE_PROGRESS_BAR = _require18.WRITE_PROGRESS_BAR;

	function writeChartData() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	    var action = arguments[1];
	    var data = action.data;
	    var axisLabel = action.axisLabel;
	    ...
	    switch (action.type) {
	        ...
	        case WRITE_BAR_DATA:
	            ...
	            var barData = { xAxis: xAxis, yAxis: yAxis };
	            return barData;
	        case WRITE_BARGROUP_DATA:
	            var bargroupData = action.data;
	...
	var scorewebStore = exports.scorewebStore = (0, _redux.combineReducers)({
	    boxyAction: boxyAction,
	    maskAction: maskAction,
	    leftNavActive: leftNavActive,
	    listFrame: listFrame,
	    userMessage: userMessage,
	    infoFormAction: infoFormAction,
	    btnGroupAction: btnGroupAction,
	    writeTableData: writeTableData,
	    showCompany: showCompany,
	    tabsSwitch: tabsSwitch,
	    resetPassword: resetPassword,
	    login: login,
	    writeChartData: writeChartData
	});
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var util = __webpack_require__(172);
	var RESET_PASSWORD_SRC = 'RESET_PASSWORD_SRC';
	var RESET_VERIFY_CODE = 'RESET_VERIFY_CODE';
	...
	function postCode(data) {
	    var url = '/scoreManagement/user/checkValidateCode';
	    return util.postRequest(url, data);
	}
	//重置密码
	function postRefreshPassword(data) {
	    var url = '/scoreManagement/user/resetPassword';
	    return util.postRequest(url, data);
	}
	module.exports = {
	    refreshSrc: refreshSrc,
	    postVerifyCode: function postVerifyCode(requestData) {
	        return function (dispatch) {
	            return postCode(requestData).then(function (data) {
	    ...
	    resetPassword: function resetPassword(requestData) {
	        return function (dispatch) {
	            return postRefreshPassword(requestData).then(function (data) {
	                (function (data) {
	                    data.json().then(function (json) {
	                        if (json.result === '0') {
	                            console.log(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function postLogin(data) {
	    var url = '/scoreManagement/user/login';
	    return util.postRequest(url, data);
	}
	function verifyCode(code) {
	    return {
	...
	function postEmail(data) {
	    var url = '/scoreManagement/user/sendEmail';
	    return util.postRequest(url, data);
	}
	module.exports = {
	    refreshSrc: refreshSrc,
	    ...
	    login: function login(requestData) {
	        return function (dispatch) {
	            return postLogin(requestData).then(function (data) {
	                data.json().then(function (json) {
	                    if (json.result === '0') {
	                        console.log(1);
	                    } else {
	    ...
	    //发送邮箱
	    sendEmail: function sendEmail(requestData) {
	        return function (dispatch) {
	            return postEmail(requestData).then(function (data) {
	                data.json().then(function (json) {
	                    if (json.result === '0') {
	                        console.log(1);
	                    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function postCreate(data) {
	    var url = '/scoreManagement/company/createCompany';
	    return util.postRequest(url, data);
	}
	//获取客户信息
	var COMPANY_MESSAGE = "COMPANY_MESSAGE";
	function getCompany(data) {
	    var url = '/scoreManagement/company/getCompanyInfo';
	...
	module.exports = {
	    creatCompany: function creatCompany(requestData) {
	        return function (dispath) {
	            return postCreate(requestData).then(function (data) {
	                data.json().then(function (json) {
	                    console.log(json);
	                });
	            }, function (error) {
	    ...
	    getCompanyMessage: function getCompanyMessage(requestData) {
	        return function (dispatch) {
	            return getCompany(requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var list = json.data;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// leftNav
	var LEFT_NAV_FIRST = 'LEFT_NAV_FIRST';
	var LEFT_NAV_NEXT = 'LEFT_NAV_NEXT';

	// selfModules
	var WRITE_SELF_MODULES = 'WRITE_SELF_MODULES';
	...
	// combineModules
	var WRITE_COMBINE_MODULES = 'WRITE_COMBINE_MODULES';
	...
	module.exports = {
	    ...
	    leftNavNext: function leftNavNext(selectNext) {
	        return {
	            type: LEFT_NAV_NEXT,
	            selectNext: selectNext
	        };
	    ...
	    leftNavFirst: function leftNavFirst(selectFirst) {
	        return {
	            type: LEFT_NAV_FIRST,
	            selectFirst: selectFirst
	        };
	    ...
	    achieveSelfModules: function achieveSelfModules(requestData) {
	        var url = '/scoreManagement/module/getSelfModules';
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var data = json.data;
	    ...
	    achieveCombineModules: function achieveCombineModules(requestData) {
	        var url = '/scoreManagement/module/getCombineModules';
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var data = json.data;
...
/***/ function(module, exports, __webpack_require__) {
	...
	//boxyAction
	var BOXY_SHOW = 'BOXY_SHOW';
	var BOXY_HIDE = 'BOXY_HIDE';

	//maskAction
	var MASK_SHOW = 'MASK_SHOW';
	var MASK_HIDE = 'MASK_HIDE';

	// eventLogManagement
	var WRITE_EVENT_LOG_MANAGEMENT = 'WRITE_EVENT_LOG_MANAGEMENT';
	...
	module.exports = {
	    ...
	    //boxyAction
	    BOXY_SHOW: BOXY_SHOW,
	    boxyShow: function boxyShow(showMsg) {
	        return {
	            type: BOXY_SHOW,
	            showMsg: showMsg
	        };
	    ...
	    //maskAction
	    MASK_SHOW: MASK_SHOW,
	    maskShow: function maskShow(showMsg) {
	        return {
	            type: MASK_SHOW,
	            showMsg: showMsg
	        };
	    ...
	    achieveEventLogManagement: function achieveEventLogManagement(requestData) {
	        var url = '/scoreManagement/eventlog/getEventlog';
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var data = json.data;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// eventLog
	var WRITE_EVENT_LOG = 'WRITE_EVENT_LOG';
	...
	module.exports = {
	    ...
	    applyCompanyList: function applyCompanyList(requestData) {
	        var url = '/scoreweb/company/getApplyList';
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var tableData = json.data.data.list;
	    ...
	    getBusinessList: function getBusinessList(requestData) {
	        var url = '/scoreweb/company/getCooperationCompanyList';
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var tableData = json.data.data.list;
	    ...
	    achieveEventLog: function achieveEventLog(requestData) {
	        var url = '/scoreweb/eventlog/getEventlog';
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var data = json.data;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// chartBarAction
	var WRITE_BAR_DATA = 'WRITE_BAR_DATA';
	...
	module.exports = {
	    ...
	    /*客户类型分布*/
	    achieveGeneralData: function achieveGeneralData(requestData) {
	        var url = '/scoreManagement/queryStatistics/getQueryStatistics';
	        var axisLabel = { x: 'companyType', y: 'count' };
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	    ...
	    /*消耗次数*/
	    achieveUsedData: function achieveUsedData(requestData) {
	        var url = '/scoreManagement/queryStatistics/getCompanyUsed';
	        var axisLabel = { x: 'company', y: 'count' };
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var used = json.used;
	    ...
	    /*客户使用情况*/
	    achieveCompanyUsedData: function achieveCompanyUsedData(requestData) {
	        var url = '/scoreManagement/queryStatistics/getQueryStatistics';
	        var axisLabel = { x: 'company', y: 'count' };
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// chartBarAction
	var WRITE_BARGROUP_DATA = 'WRITE_BARGROUP_DATA';
	...
	module.exports = {
	    ...
	    achieveModuleUsedData: function achieveModuleUsedData(requestData) {
	        var url = '/scoreManagement/queryStatistics/getModuleUsed';
	        var axisLabel = { x: 'date', y: 'used' };
	        var data = {
	            page: 1,
	            allPage: 2,
	            list: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// progressBarAction
	var WRITE_PROGRESS_BAR = 'WRITE_PROGRESS_BAR';
	...
	module.exports = {
	    ...
	    achieveProgressBarData: function achieveProgressBarData(requestData) {
	        var url = '/scoreManagement/queryStatistics/getThresholdValues';
	        return function (dispatch) {
	            return util.getRequest(url, requestData).then(function (data) {
	                data.json().then(function (json) {
	                    var _json$data = json.data;
	                    var list = _json$data.list;
	                    var allPage = _json$data.allPage;
	                    var page = _json$data.page;
